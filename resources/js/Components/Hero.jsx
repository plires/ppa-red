...
import heroBg from '../../images/landing/hero/hero-background-with-orange.webp';
    ...
    return (
        ...
        >
            <div className={styles.container}>
                ...
                {/* Columna izquierda: logo + texto + formulario */}
                <div className={styles.left}>
                    ...
                    <div className={styles.headlines}>
                        ...
                        <p className={styles.subtext}>
                            <strong>PPA Red</strong> te conecta con instaladores oficiales en todo el país.
                        </p>
                    </div>

                    <div className={styles.formCard}>
                        <h2 className={styles.formTitle}>
                            Pedí tu presupuesto<br />¡GRATIS!
                        </h2>
                        ...
                        <form onSubmit={onSubmit}>
                            ...
                            <div className={styles.field}>
                                ...
                                {errors.province_id && <p className={styles.error}>{errors.province_id}</p>}
                            </div>
                            ...
                            {data.province_id && (
                                <div className={styles.field}>
                                    ...
                                    {errors.locality_id && <p className={styles.error}>{errors.locality_id}</p>}
                                </div>
                            )}
