...
export default function Create({ provinces, partners }) {
    ...
    function submit(e) {
        e.preventDefault();
        post(route('localities.store'));
    }

    return (
        <AuthenticatedLayout header="Localidades / Nueva">
            <div className="mx-auto max-w-xl">
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                    <h2 className="mb-6 text-lg font-semibold text-gray-800">Nueva Localidad</h2>
