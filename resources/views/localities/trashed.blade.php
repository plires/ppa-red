    ...
    <div class="content-wrapper data-table-lists">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1>Listado de Localidades Eliminadas</h1>
                    </div>
                        ...
                        <div class="card card-outline card-primary">
                            <div class="card-header header-index">
                                <div class="content-buttons">
                                    ...
                                    <a href="{{ route('localities.index') }}" type="button"
                                        ...
                                        @else
                                            @foreach ($localities as $locality)
                                                <tr class="align-middle">
                                                    ...
                                                    <td>
                                                        {{ $locality->FormattedDeletedDate }}
                                                    </td>
                                                    <td>
                                                        <form action="{{ route('localities.restore', $locality->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <button type="submit"
