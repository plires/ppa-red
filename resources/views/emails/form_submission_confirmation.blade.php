...
@section('content')
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td align="center">
                <div style="display:inline-block; width:64px; height:64px; border-radius:50%; background-color:#FF7500; text-align:center; line-height:64px; font-size:30px; color:#FFFFFF; font-family:Arial, Helvetica, sans-serif; mso-line-height-rule:exactly;">
                    &#10003;
                </div>
            </td>
        </tr>
    ...
    <p style="margin:0 0 32px; font-family:Arial, Helvetica, sans-serif; font-size:15px; font-weight:400; color:#6B7280; line-height:1.7; text-align:center;">
        ...
        <tr>
            <td style="background-color:#FFF7ED; border:1px solid #FED7AA; border-left:4px solid #FF7500; border-radius:0 8px 8px 0; padding:20px 24px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="vertical-align:middle; width:52px;">
                            <div style="display:inline-block; width:44px; height:44px; border-radius:50%; background-color:#FF7500; text-align:center; line-height:44px; font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:900; color:#FFFFFF; mso-line-height-rule:exactly;">
                                {{ mb_strtoupper(mb_substr($partner->name ?? 'P', 0, 1)) }}
                            </div>
                        </td>
                        <td style="padding-left:14px; vertical-align:middle;">
                            <p style="margin:0 0 2px; font-family:Arial, Helvetica, sans-serif; font-size:15px; font-weight:700; color:#111827; line-height:1.3;">
                                {{ $partner->name }}
                            </p>
                            <p style="margin:0; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:400; color:#9CA3AF; line-height:1.3;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top:16px; border-top:1px solid #FED7AA; padding-top:16px;">
                    @if ($partner->email)
                    <tr>
                        <td style="padding:4px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#92400E; width:30%; vertical-align:top;">Email</td>
                    ...
                    @if ($partner->phone)
                    <tr>
                        <td style="padding:4px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#92400E; vertical-align:top;">Teléfono</td>
    ...
    <p style="margin:0 0 28px; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:400; color:#374151; line-height:1.75;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td style="background-color:#F9FAFB; border:1px solid #E5E7EB; border-radius:6px; padding:16px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="padding:5px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#6B7280; width:35%; vertical-align:top;">Nombre</td>
                        <td style="padding:5px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:600; color:#111827; vertical-align:top;">{{ $data['name'] ?? '—' }}</td>
                    </tr>
                    <tr>
                        <td style="padding:5px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#6B7280; vertical-align:top;">Email</td>
                        <td style="padding:5px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:600; color:#111827; vertical-align:top;">{{ $data['email'] ?? '—' }}</td>
                    </tr>
                    @if (!empty($data['phone']))
                    <tr>
                        <td style="padding:5px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#6B7280; vertical-align:top;">Teléfono</td>
                        <td style="padding:5px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:600; color:#111827; vertical-align:top;">{{ $data['phone'] }}</td>
                    </tr>
                    @endif
                    @if (!empty($data['message']))
                    <tr>
                        <td style="padding:5px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#6B7280; vertical-align:top;">Consulta</td>
                        <td style="padding:5px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:400; color:#374151; vertical-align:top; line-height:1.6; white-space:pre-line;">{{ $data['message'] }}</td>
                    </tr>
                    @endif
                </table>
            </td>
