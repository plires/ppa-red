...
@section('title', 'Mensaje sin partner asignado — ' . config('app.name'))

@section('preheader', 'Llegó un nuevo mensaje en una consulta cuya localidad no tiene partner asignado.')
...
@section('content')
    ...
    <p style="margin:0 0 16px; font-family:Arial, Helvetica, sans-serif; font-size:16px; font-weight:400; color:#374151; line-height:1.6;">
        El solicitante envió un nuevo mensaje en una consulta de <strong style="color:#000000;">PPA RED</strong>
        cuya localidad <strong>no tiene ningún partner asignado</strong>. Nadie fue notificado
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td style="background-color:#FFF7ED; border-left:4px solid #FF7500; border-radius:0 6px 6px 0; padding:20px 24px;">
                <p style="margin:0; font-family:Arial, Helvetica, sans-serif; font-size:15px; font-weight:400; color:#374151; line-height:1.7; white-space:pre-line;">{{ $formResponse->message }}</p>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td style="padding:12px 16px; background-color:#F9FAFB; border:1px solid #E5E7EB; border-radius:6px;">
                <p style="margin:0; font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#6B7280; line-height:1.6;">
                    <strong style="color:#374151;">Fecha del mensaje:</strong>
                    {{ $formResponse->created_at->format('d/m/Y \a \l\a\s H:i') }} hs
                    &nbsp;·&nbsp;
    ...
    <p style="margin:0; font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#9CA3AF; text-align:center; line-height:1.6;">
        El solicitante no fue notificado de este inconveniente y sigue esperando una respuesta.
    </p>
