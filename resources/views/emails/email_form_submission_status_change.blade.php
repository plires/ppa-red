...
@endphp
    ...
    @if ($recipientType === 'partner')
        ...
        <h1 style="margin:0 0 24px; font-family:Arial, Helvetica, sans-serif; font-size:24px; font-weight:900; color:#000000; line-height:1.2;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td style="background-color:#FFF7ED; border:1px solid #FED7AA; border-left:4px solid #FF7500; border-radius:0 8px 8px 0; padding:24px 28px;">
                ...
                <p style="margin:0; font-family:Arial, Helvetica, sans-serif; font-size:16px; font-weight:400; color:#1F2937; line-height:1.8; white-space:pre-line;">{{ $body }}</p>
            </td>
        </tr>
    </table>
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
        ...
        <tr style="background-color:#FAFAFA;">
            <td style="padding:11px 16px; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:700; color:#6B7280; text-transform:uppercase; letter-spacing:0.5px; border-bottom:1px solid #E5E7EB; width:36%; vertical-align:top;">
                Solicitante
            </td>
            <td style="padding:11px 16px; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:600; color:#111827; border-bottom:1px solid #E5E7EB; vertical-align:top;">
                {{ $dataUser['name'] ?? '—' }}
            </td>
        </tr>
        ...
        <tr>
            <td style="padding:11px 16px; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:700; color:#6B7280; text-transform:uppercase; letter-spacing:0.5px; border-bottom:1px solid #E5E7EB; vertical-align:top;">
                Email
            </td>
            <td style="padding:11px 16px; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#111827; border-bottom:1px solid #E5E7EB; vertical-align:top;">
        ...
        <tr>
            <td style="padding:11px 16px; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:700; color:#6B7280; text-transform:uppercase; letter-spacing:0.5px; vertical-align:top;">
                Fecha de consulta
            </td>
            <td style="padding:11px 16px; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#111827; vertical-align:top;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        ...
                        <td width="85%" style="background-color:{{ $msgBg }}; border-left:{{ $msgBorderL }}; border-radius:0 6px 6px 0; padding:12px 16px; vertical-align:top;">
                            <p style="margin:0 0 5px; font-family:Arial, Helvetica, sans-serif; font-size:11px; font-weight:700; color:{{ $msgNameColor }}; text-transform:uppercase; letter-spacing:0.4px;">
                                {{ $msgSenderName }}
                            ...
                            <p style="margin:0; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:400; color:#374151; line-height:1.6;">
                                {{ $response->message }}
                            </p>
                        </td>
                        @if (!$pushRight)<td width="15%">&nbsp;</td>@endif
        ...
        <tr>
            <td style="padding:0; font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#9CA3AF; text-align:center;">
    ...
    @else
        ...
        <p style="margin:24px 0 0; font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#9CA3AF; text-align:center; line-height:1.6;">
